...
urlpatterns = [
    ...
    path('api/products/search_category/<str:category_id>/', product_endpoints.find_products_in_category_endpoint),
    path('api/products/categories/<str:category_id>/', product_endpoints.get_category_endpoint),
    path('api/products/subcategories/<str:subcategory_id>/', product_endpoints.get_subcategory_endpoint),
    path('api/products/subcategories/category/<str:category_id>/', product_endpoints.get_subcategories_by_category_endpoint),
    path('api/products/categories/remove/<str:category_id>/', product_endpoints.remove_category_endpoint),
    path('api/products/subcategories/remove/<str:subcategory_id>/', product_endpoints.remove_subcategory_endpoint),
