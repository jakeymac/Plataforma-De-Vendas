...
urlpatterns = [
    ...
    path('api/products/subcategories/<int:subcategory_id>', product_endpoints.get_subcategory_endpoint),
    path('api/products/subcategories/category/<int:category_id>', product_endpoints.get_subcategories_by_category_endpoint),
